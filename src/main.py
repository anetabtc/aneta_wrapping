...
def main() -> None:
    ...
    parser.add_argument('--option',
                        default='mint',
                        help='whether function should \'mint\' or \'burn\'')
    ...
    parser.add_argument('--btc_wallet_id',
                        default=None,
                        help='id of users btc wallet')
    ...
    if args.option == 'mint':
        print(
            initiateMint(amount=args.amount,
                         btc_vault_id=args.btc_vault_id,
                         btc_wallet_id=args.btc_wallet_id,
                         network=args.network,
                         vault_id=args.vault_id,
                         wallet_id=args.wallet_id))
    elif args.option == 'burn':
        print(
            initiateBurn(amount=args.amount,
                         btc_vault_id=args.btc_vault_id,
                         btc_wallet_id=args.btc_wallet_id,
                         network=args.network,
                         vault_id=args.vault_id,
